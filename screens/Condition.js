  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <Text style={styles.text}>
          2. คุณสามารถสะสมเหรียญได้โดยการสแกน QR code หน้าถุงขยะ Big bag
        ...
        <Text style={styles.text}>
          4.
          เหรียญที่สะสมจะสามารถนำมาแลกสิทธิประโยชน์ต่างๆภายในมหาวิทยาลัยได้ในอนาคต
        </Text>
        <Text style={styles.textRed}>
         * ขยะแต่ละชิ้นสามารถสแกนเพื่อรับเหรียญได้ 5 ครั้ง/วัน
        </Text>
      </View>
      </View>
    </View>
